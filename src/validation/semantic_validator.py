...
class SemanticValidator(Validator):
    ...
    FALLBACK_USER_TEMPLATE = (
        ...
        "6. WORD BUDGET: Is the caption strictly between 50 and 70 words?\n\n"
        "Source Description:\n{narrative}\n\n"
    ...
    def validate(
        ...
        cross_style_system_prompt = (
            ...
            "Guidelines on Hallucinations vs. Creative Styling/Metaphors:\n"
            "- Do NOT count style-specific metaphors, software analogies (e.g., 'debug', 'compile', 'patch', 'exception', 'system stabilizes' for tech_humor), "
            "or creative expressions (e.g., 'little monk', 'roommate', 'living its best life' for humorous styles) as hallucinations or missing facts, "
            "provided they do not alter or contradict the core physical actions, objects, and events of the narrative.\n"
            "- Hallucinations are entirely new, ungrounded physical events, actions, characters, or objects that are not in the narrative and cannot be "
            "explained as stylistic metaphors (e.g., introducing a dog, saying the rabbit ate a carrot, or claiming a butterfly flew away when it didn't).\n\n"
